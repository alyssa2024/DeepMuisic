...
CONFIG = {
    ...
    "data": {
        ...
        "num_cycles": 4,
        # --- single-instance eval (E1 baseline comparison harness) ---
        "patch_num_cycles": 4,
        "patch_hop_cycles": 4,
        "num_total_patches": 54,
        "train_fraction": 0.6,
        "val_fraction": 0.2,
        "test_fraction": 0.2,
    ...
    "signal": {
        ...
        "snr_db": 20,
        # single-instance: 'sample_once' draws a random freq per seed (500-case dist);
        # 'fixed' uses true_frequency_hz / band centers.
        "single_instance_parameter_source": "sample_once",
    },
    "frequency": {
    ...
    "model": {
        ...
        # Continuous-time positional encoding (#4 tier-2), keyed by real t_n.
        # "none" | "fourier" (additive multiscale sin/cos) | "rope" (rotary-in-time).
        # Overridable on the CLI via --time_encoding / --time_num_freqs /
        # --time_min_hz / --time_max_hz.
        "time_encoding": "none",
        "time_num_freqs": 16,
        "time_min_hz": 1.0,
        "time_max_hz": 1000.0,
